...
description: "Full reference for POST /avl/add/configs — required fields, obstacle schema, validation rules, and error responses for the simulation config payload."
---
