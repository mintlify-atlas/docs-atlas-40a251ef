...
description: "Reference for all ten obstacle types served by GET /data/json/obstacles_types.json — including numeric IDs, type names, and damage values used by the frontend."
---
